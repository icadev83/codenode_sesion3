<?php
/*
Template Name: Registro de ropa deportiva
*/
...
// Redirige a la misma página para mostrar el mensaje sin que se duplique al recargar
    wp_safe_redirect(get_permalink(get_queried_object_id()));
    exit();
}
...
.pie-pagina {
    ...
    <header class="cabecera">
        <h2>Completa el formulario para registrar tu ropa deportiva</h2>                           
    </header>
    ...
    <footer class="pie-pagina">
        <p><small>&copy; Todos los derechos reservados.<br>2026</small></p>
    </footer>
